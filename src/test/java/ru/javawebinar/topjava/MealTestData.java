...
public class MealTestData {
    ...
    public static final Meal MealAdmin1 = new Meal(MEAL_ID + 7, LocalDateTime.of(2020, Month.JANUARY, 30, 9, 0), "Завтрак Админа", 330);
    public static final Meal MealAdmin2 = new Meal(MEAL_ID + 8, LocalDateTime.of(2020, Month.JANUARY, 30, 12, 0), "Обед Админа", 600);
    public static final Meal MealAdmin3 = new Meal(MEAL_ID + 9, LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Ужин Админа", 580);
    public static final Meal MealAdmin4 = new Meal(MEAL_ID + 10, LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак Админа", 430);
    public static final Meal MealAdmin5 = new Meal(MEAL_ID + 11, LocalDateTime.of(2020, Month.JANUARY, 31, 12, 0), "Обед Админа", 700);
    public static final Meal MealAdmin6 = new Meal(MEAL_ID + 12, LocalDateTime.of(2020, Month.JANUARY, 31, 21, 0), "Ужин Админа", 400);
